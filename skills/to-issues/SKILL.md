...
If you have not already explored the codebase, do so to understand the current state of the code. Before exploring, follow [../deprecated/grill-with-docs/DOMAIN-AWARENESS.md](../deprecated/grill-with-docs/DOMAIN-AWARENESS.md). Issue titles and descriptions should use the project's `CONTEXT.md` vocabulary.
